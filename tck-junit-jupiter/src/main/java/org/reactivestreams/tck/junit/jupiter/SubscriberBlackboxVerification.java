...
import org.reactivestreams.tck.junit.jupiter.TestEnvironment.ManualPublisher;
...
import static org.reactivestreams.tck.junit.jupiter.SubscriberWhiteboxVerification.BlackboxSubscriberProxy;
...
public abstract class SubscriberBlackboxVerification<T> extends WithHelperPublisher<T>
  ...
  @BeforeAll public void startPublisherExecutorService() { publisherExecutor = Executors.newFixedThreadPool(4); }
  @AfterAll public void shutdownPublisherExecutorService() { if (publisherExecutor != null) publisherExecutor.shutdown(); }
  ...
  public void notVerified() {
    throw new TestAbortedException("Not verified using this TCK.");
  }
}
